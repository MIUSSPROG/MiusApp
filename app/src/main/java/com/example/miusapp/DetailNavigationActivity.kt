        ...
        db.collection("Users").document(prefs.myUUId)
            ...
            .addSnapshotListener { value, error ->
                ...
                value?.let {
                    ...
                    for(document in it.documents){
                        ...
                        if (newData != null) {
                            when(newData.question){
                                programItems[0] -> program1Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                programItems[1] -> program2Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                programItems[2] -> program3Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                programItems[3] -> program4Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                programItems[4] -> program5Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                programItems[5] -> program6Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))

                                projectItems[0] -> project1Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[1] -> project2Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[2] -> project3Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[3] -> project4Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[4] -> project5Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[5] -> project6Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[6] -> project7Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                projectItems[7] -> project8Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))

                                qualificationItems[0] -> qualification1Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[1] -> qualification2Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[2] -> qualification3Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[3] -> qualification4Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[4] -> qualification5Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[5] -> qualification6Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[6] -> qualification7Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                qualificationItems[7] -> qualification8Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))

                                achievementItems[0] -> achievement1Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                achievementItems[1] -> achievement2Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                achievementItems[2] -> achievement3Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                achievementItems[3] -> achievement4Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))

                                resultItems[0] -> result1Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                ...
                                planItems[2] -> plan3Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                planItems[3] -> plan4Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                planItems[4] -> plan5Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                planItems[5] -> plan6Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                                planItems[6] -> plan7Items.add(SliderDetailRvItem(newData.id, newData.answer, getTitleDrawable(background)))
                            }
                        }
                    }
                    ...
                    binding.viewPagerNavDetail.adapter = SliderDetailAdapter(title, categoryItems,this, supportFragmentManager)
                    if(position == -1) {
